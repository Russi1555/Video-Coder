...
public class EncodeAndMuxTest {
    ...
    private static final File OUTPUT_DIR = new File("/storage/emulated/0/Download/Telegram/");
    ...
    public void testEncodeVideoToMp4() throws IOException {
        // QVGA at 2Mbps
        mWidth = 416; //w do yuv que eu quero
        mHeight = 240;
        mBitRate = 2000000;
...
//SE PARAR DE FUNCIONAR O ORIGINAL TA AQUI https://bigflake.com/mediacodec/EncodeAndMuxTest.java.txtgenerateSurfaceFrame
